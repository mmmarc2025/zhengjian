  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-accent/10 flex flex-col">
        ...
        <Card className="w-full max-w-md shadow-xl border-border/50 bg-card/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              ...
              className="w-full h-12 bg-[#00B900] hover:bg-[#00A000] text-white font-medium text-base gap-3"
            >
              <LineIcon />
              使用 LINE 登入
            </Button>
            ...
            <Button
              ...
              variant="outline"
              className="w-full h-12 font-medium text-base gap-3 bg-white hover:bg-gray-50 text-gray-700 border-gray-300"
            >
              <GoogleIcon />
              使用 Google 登入
            </Button>
      ...
      <footer className="p-4 text-center text-sm text-muted-foreground">
        <p>© 2026 政見 political.now. All rights reserved.</p>
      </footer>
    </div>
  );
}
